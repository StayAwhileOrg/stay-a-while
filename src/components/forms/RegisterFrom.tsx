...
export function RegisterForm() {
    ...
    const onSubmit = (data: { firstName: string, lastName: string, email: string, password: string, phone: number, imgUrl: string, bio: string }) => {
        fetchRegister(data.firstName, data.lastName, data.email, data.password, data.phone, data.imgUrl, data.bio);
    };
                ...
                <div>
                    ...
                    <input
                        ...
                        {...register("imgUrl", {
                            ...
                            pattern: {
                                value: /^(https?:\/\/.*\.(?:png|jpg|jpeg|gif|webp))$/i, // Ensures a valid image URL
