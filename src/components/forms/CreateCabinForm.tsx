...
export function CabinForm() {
  ...
  return (
    <div className="max-w-2xl mx-auto py-8 px-4 lg:py-20">
      <h1 className={"text-2xl lg:text-3xl font-bold flex justify-center font-primary mb-6 lg:mb-10"}>Create a Cabin</h1>
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          {fields.map((field, index) => (
            <div key={field.id} className="flex gap-2 mb-2">
              ...
              <input
                ...
                placeholder="e.g. Cozy cabin in the snowy woods"
                className="border p-2 rounded flex-1"
              />
              {fields.length > 1 && (
                <button
        ...
        <div>
          ...
          {errors.facilities?.capacity && (
            <p className="text-red-500 text-sm">
              {errors.facilities.capacity.message}
            </p>
          )}
          <input
            type="number"
          ...
          {errors.facilities?.beds && (
            <p className="text-red-500 text-sm">
              {errors.facilities.beds.message}
            </p>
          )}
          <label className="flex items-center gap-2 cursor-pointer">
            <input
              ...
              {...register('facilities.petsAllowed')}
            />
            Pets Allowed
          </label>
          <label className="flex items-center gap-2 cursor-pointer">
            <input
              type="checkbox"
              className="cursor-pointer"
              {...register('facilities.smokingAllowed')}
            />
            Smoking Allowed
          </label>
          <label className="flex items-center gap-2 cursor-pointer">
            <input
              type="checkbox"
              className="cursor-pointer"
              {...register('facilities.electricity')}
            />
            Electricity
          </label>
          <label className="flex items-center gap-2 cursor-pointer">
