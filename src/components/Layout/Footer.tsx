...
export function Footer() {
    ...
    return (
        <div className={"m-10"}>
            ...
            <footer className="m-10 flex flex-col justify-between max-w-[980px] mx-auto">
                <div className="flex md:flex-row justify-between flex-col items-center text-center gap-10 ">
